...
String index_html = "<!DOCTYPE html><html><body><form id='configForm'><h2>Morphing ClockQ Configuration</h2>SSID:     <input type='text' name='wifi_ssid' value='%WIFI_SSID%' maxlength='50'><br>Password: <input type='password' name='wifi_pass' value='%WIFI_PASS%' maxlength='50'><br><br>Timezone: <input type='text' name='timezone' value='%TIMEZONE%' maxlength='3'><br>24 Hour format: <input type='text' name='military' value='%MILITARY%'><br>Date Format: <input type='text' name='date_fmt' value='%DATE_FMT%'><br>Daylight Savings Time (true/false): <input type='text' name='dst_sav' value='%DST_SAV%'><br><br><p>1=Cyan, 2=Red, 3=Blue, 4=Yellow, 5=Bright Blue, 6=Orange, 7=Green</p>Color Palette: <input type='number' name='c_palet' value='%C_PALET%' maxlength='3' min='1' max='7'><br>Brightness: <input type='number' name='brightness' value='%BRIGHTNESS%' maxlength='2' min='20' max='70'><p>Dim the display for night time hours in 24hr format, enter 0 in both fields to disable</p>Night Start: <input type='number' name='nightStart' value='%NIGHT_START%' maxlength='2' min='0' max='24'><br>Night End: <input type='number' name='nightEnd' value='%NIGHT_END%' maxlength='2' min='0' max='24'><br><br><p>Read the weather docs for all the details - weather.pdf</p><p>1=WeatherAPI.com, 2=WeatherBit.io, 3=PirateWeather.net, 4=OpenMeteo.io, 5=WeatherUnlocked</p>Weather Service: <input type='number' name='weatherservice' value='%WEATHER_SERVICE%' maxlength='3' min='1' max='9'><br>API Key:         <input type='text' name='apiKey' value='%API_KEY%' maxlength='50'><br>Postal Code:     <input type='text' name='postal_code' value='%POSTAL_CODE%'><br>Country Code:    <input type='text' name='country_code' value='%COUNTRY_CODE%'><br>Latitude:        <input type='text' name='latitude' value='%LATITUDE%'><br>Longitude:       <input type='text' name='longitude' value='%LONGITUDE%'><br>Define:          <input type='text' name='wdefine' value='%WDEFINE%'><br>Metric (Y/N):    <input type='text' name='u_metric' value='%U_METRIC%' maxlength='1'><br>Weather Animation (Y/N): <input type='text' name='w_animation' value='%W_ANIMATION%' maxlength='1'><br><br><input type='button' onclick='saveSettings()' value='Save'></form><script>function saveSettings() {var form = document.getElementById('configForm');var formData = new FormData(form);fetch('/save', {method: 'POST',body: formData}).then(response => {}).catch(error => {});}</script></body></html>";
